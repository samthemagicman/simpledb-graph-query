...
public class CreateGraphDB {
    public static void main(String[] args) {
		...
		try {
			...
			String s = "create table GRAPH(SId int, SName varchar(10), MajorId int, GradYear int)";
			stmt.executeUpdate(s);
			System.out.println("Table GRAPH created.");

			s = "insert into GRAPH(SId, SName, MajorId, GradYear) values ";
			...
			System.out.println("GRAPH records inserted.");
